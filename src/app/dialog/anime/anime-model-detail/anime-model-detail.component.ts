...
@Component({
  selector: 'app-anime-model-detail',
  templateUrl: './anime-model-detail.component.html',
  styleUrls: ['./anime-model-detail.component.css']
})
export class AnimeModelDetailComponent implements OnInit {
